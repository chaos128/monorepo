...
const SaleDefault: React.FC<IconProps> = ({ size }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <circle cx="9.5" cy="8.5" r="1.5" fill="white" stroke="#1A1A1A" />
      <circle cx="14.5" cy="15.5" r="1.5" fill="white" stroke="#1A1A1A" />
    </svg>
  );
};

export default SaleDefault;
